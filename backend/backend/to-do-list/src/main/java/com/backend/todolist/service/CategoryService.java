...
import com.backend.todolist.controller.CategoryRequest;
...
public class CategoryService {
    ...
    public Category addCategory(CategoryRequest categoryRequest, String username) {
        Category category = new Category(username, categoryRequest.getTitle());
